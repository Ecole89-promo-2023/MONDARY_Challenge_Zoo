...
const { registerEmployee, loginEmployee, deleteEmployee, updateEmployee, linkEmployeeToAnimal, getOne, getAll, getAllAnimals } = require('../controllers/employeeController');
...
router.post('/link/:employeeId/:animalId', auth, admin, linkEmployeeToAnimal);
